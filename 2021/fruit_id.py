...
#    Sep 09, 2021 03:01:08 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    fruit_id_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    fruit_id_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.Button1.place(relx=0.717, rely=0.133, height=33, width=126)
        ...
        self.Entry1.place(relx=0.1, rely=0.133, height=34, relwidth=0.557)
        ...
        self.Canvas1.place(relx=0.418, rely=0.356, relheight=0.222
                , relwidth=0.167)
        ...
        self.Button2.place(relx=0.46, rely=0.644, height=33, width=56)
        ...
        self.Label1.place(relx=0.108, rely=0.822, height=46, width=472)
